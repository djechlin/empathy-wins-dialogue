  ...
  'categories': [
    {
      ...
      'icon': 'target',
      'score': 8,
      'feedback': 'Excellent opening! You introduced yourself and the issue clearly, then immediately moved to the 1-10 question. This is exactly what deep canvassing recommends - no \'exit phrases\' or small talk, just straight to the point.',
      'examples': [
    ...
    },
    {
      ...
      'icon': 'heart',
      'score': 4,
      'feedback': 'You started to share personal details about Karen and your first date, which was a good beginning. However, the vulnerability felt surface-level. Deep canvassing asks you to name someone you love, say what you love about them, and describe a moment they were really there for you. Your story stayed at the facts level rather than showing deep emotional connection.',
      'examples': [
        'Mentioned Karen and your first date at the wine bar',
        'Shared that you\'ve been married for a year'
      ]
    },
    {
      'id': 'listening',
      ...
      'icon': 'ear',
      'score': 7,
      'feedback': 'Great job practicing reflection and picking up on the voter\'s interests! You noticed their love for the neighborhood, walking downtown, and the farmers market. You used their words back to them and built on their interests. This created genuine connection.',
      'examples': [
    ...
    },
    {
      ...
      'icon': 'compass',
      'score': 6,
      'feedback': 'You did well avoiding fact-dumping and political jargon. You kept the conversation personal and connected to their experience. However, you could have asked more probing questions about their feelings and experiences rather than mostly sharing your own perspective.',
      'examples': [
  ...
  'keyMoments': [
    {
      ...
      'quote': 'hey I\'m here to talk about expanding bike lane access! I want to ask real quick, when you think of your support for bike lanes on a scale of 1 to 10...'
    },
    {
      'timestamp': 'Mid conversation',
      'type': 'missed_opportunity',
      'description': 'When sharing about Karen, you could have gone deeper into vulnerability by describing what you love about her or a moment she was there for you',
