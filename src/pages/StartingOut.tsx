        ...
        <div className="container-custom py-12">
          ...
          <div className="max-w-6xl mx-auto mb-16">
            <div className="space-y-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <Card className="border-dialogue-neutral/30">
                      ...
                      <CardContent className="pt-0">
                        <p className="text-sm text-muted-foreground">
                          Quick conversations focused on securing votes through information sharing and persuasion arguments.
                        </p>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="border-dialogue-purple/30 bg-dialogue-purple/5">
                      ...
                      <CardContent className="pt-0">
                        <p className="text-sm">
                          Longer, in-depth conversations that build genuine connection through shared stories before attempting persuasion.
                        </p>
                      </CardContent>
                    </Card>
                  </div>
                  ...
                  <FactCard topic="Typical Conversation Flow">
                    <div className="space-y-4">
                      <div className="flex items-start gap-3 p-3 bg-dialogue-neutral/10 rounded-lg">
                        <div className="w-6 h-6 bg-dialogue-purple text-white rounded-full flex items-center justify-center text-xs font-bold">
                          1
                        </div>
                        <div>
                ...
                <div className="space-y-4 mb-6">
                  <FactCard topic="Framing the issue">
                    <FactCardList>
                      ...
                      <li>
                        Right after introducing yourself, ask them how they feel about the issue on a scale of 1-10 as soon as possible.
                        This tells the voter why you're here, and sparks their interest
                      </li>
                  ...
                  <DosAndDonts>
                    <Dos title="Issue Dos">
                      <DosAndDontsItem type="do">Should impact people directly</DosAndDontsItem>
                      <DosAndDontsItem type="do">Should have the potential to impact people positively</DosAndDontsItem>
                    </Dos>

                    <Donts title="Issue Don'ts">
                      <DosAndDontsItem type="dont">Use politics jargon like "filibuster" and "supermajority"</DosAndDontsItem>
                      <DosAndDontsItem type="dont">Use an "attack" issue like "tax the rich" or "vote out corruption"</DosAndDontsItem>
                    </Donts>
                  </DosAndDonts>
                  ...
                  <DosAndDonts>
                    <Dos>
                      <DosAndDontsItem type="do">Share specific, personal details that create emotional connection</DosAndDontsItem>
                      <DosAndDontsItem type="do">Focus on how the issue affects people you care about</DosAndDontsItem>
                      <DosAndDontsItem type="do">Use everyday language that anyone can understand</DosAndDontsItem>
                      <DosAndDontsItem type="do">Show vulnerability and authentic emotion</DosAndDontsItem>
                    </Dos>

                    <Donts>
                      <DosAndDontsItem type="dont">Use political jargon or partisan talking points</DosAndDontsItem>
                      <DosAndDontsItem type="dont">Make it about statistics or policy details</DosAndDontsItem>
                      <DosAndDontsItem type="dont">Tell a generic story that could apply to anyone</DosAndDontsItem>
                      <DosAndDontsItem type="dont">Rush through it or make it too long</DosAndDontsItem>
                    </Donts>
                  </DosAndDonts>
                  ...
                  <DosAndDonts>
                    <ConversationDos>
                      <ConversationDosAndDontsItem type="do">Ask "Tell me about a time when..." to get stories</ConversationDosAndDontsItem>
                      <ConversationDosAndDontsItem type="do">Listen for emotional moments and explore them</ConversationDosAndDontsItem>
                      <ConversationDosAndDontsItem type="do">Give them space to think and process</ConversationDosAndDontsItem>
                      <ConversationDosAndDontsItem type="do">Let them make connections themselves</ConversationDosAndDontsItem>
                    </ConversationDos>

                    <ConversationDonts>
                      <ConversationDosAndDontsItem type="dont">Jump straight into political arguments</ConversationDosAndDontsItem>
                      <ConversationDosAndDontsItem type="dont">Tell them how their story connects to the issue</ConversationDosAndDontsItem>
                      <ConversationDosAndDontsItem type="dont">Rush them or fill silence immediately</ConversationDosAndDontsItem>
                      <ConversationDosAndDontsItem type="dont">Judge or dismiss their experiences</ConversationDosAndDontsItem>
                    </ConversationDonts>
                  </DosAndDonts>
              ...
              >
                <p className="mb-6">
                  Active listening is more than just hearing words—it's about understanding the meaning and emotion behind them. This
                  activity covers techniques for demonstrating that you truly understand what someone is saying before responding.
                </p>
