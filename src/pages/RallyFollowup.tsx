...
const RALLY_EVENTS = [
  ...
  { date: 'Mar 21', location: 'Denver, CO', venue: 'Civic Center Park' },
  { date: 'Mar 22', location: 'Tucson, AZ', venue: 'Catalina High School' },
  {
    date: 'Apr 12',
    location: 'Los Angeles, CA',
    venue: 'Grand Park (coinciding with an appearance at Coachella introducing Clairo)',
  },
  { date: 'Apr 13', location: 'Salt Lake City, UT', venue: 'Jon M. Huntsman Center' },
  { date: 'Apr 14', location: 'Nampa, ID', venue: 'Ford Idaho Center' },
  { date: 'Apr 15', location: 'Folsom, CA', venue: 'Folsom Lake College' },
  { date: 'Apr 15', location: 'Bakersfield, CA', venue: 'Dignity Health Arena' },
  { date: 'Apr 16', location: 'Missoula, MT', venue: 'Adams Center' },
  { date: 'May 1', location: 'Philadelphia, PA', venue: 'Philadelphia City Hall' },
  { date: 'May 2', location: 'Harrisburg, PA', venue: 'Pennsylvania Farm Show Complex & Expo Center' },
  { date: 'May 3', location: 'Bethlehem, PA', venue: 'Lehigh University' },
  { date: 'Jun 20', location: 'McAllen, TX', venue: 'McAllen Performing Arts Center' },
  { date: 'Jun 21', location: 'Shreveport, LA', venue: 'Shreveport Municipal Auditorium' },
  { date: 'Jun 21', location: 'Tulsa, OK', venue: 'Arvest Convention Center' },
  { date: 'Jun 22', location: 'Amarillo, TX', venue: 'Globe-News Center for the Performing Arts' },
