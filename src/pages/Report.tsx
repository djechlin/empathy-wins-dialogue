        ...
        <div className="grid gap-6 mb-8">
            ...
            <CardContent>
              ...
              <div className="mt-4 p-3 bg-orange-100 rounded-lg">
                <p className="text-sm text-orange-800">
                  <strong>Tip:</strong> When voters mention specific family members by name or relationship, that's your cue to dig deeper.
                  Ask about their feelings, their specific situation, or how the issue affects that person directly.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-green-200 bg-green-50">
            ...
            <CardContent className="text-green-700">
              <ul className="space-y-2">
                ...
                {achievedTechniques.includes('shared-story') && <li>• You made the conversation relatable by sharing a personal story</li>}
          ...
          <Card className="border-orange-200 bg-orange-50">
            ...
            <CardContent className="text-orange-700">
              <ul className="space-y-2">
                {!achievedTechniques.includes('plain-language') && <li>• Try using more sensory, emotional language to connect better</li>}
                ...
                {!achievedTechniques.includes('shared-story') && <li>• Share a personal story to make the conversation more relatable</li>}
