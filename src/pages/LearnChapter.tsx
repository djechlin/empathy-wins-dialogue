        ...
        <div className="container-custom py-12">
          ...
          <div className="max-w-4xl mx-auto mb-8">
            <div className="flex items-center gap-2 text-sm text-muted-foreground mb-4">
              <a href="/learn" className="hover:text-dialogue-purple">Learn</a>
                    ...
                    <div className="space-y-6">
                      <section>
                        ...
                        <div className="prose max-w-none">
                          <p>
                            This section would contain the actual lesson content with text, 
                            images, and interactive elements. It would explain the key
                            concepts in detail.
                          </p>
                          ...
                          <div className="bg-dialogue-neutral p-4 rounded-md my-4 border-l-4 border-dialogue-purple">
                            ...
                            <p className="text-muted-foreground">
                              A key insight or important takeaway would go here to emphasize 
                              a crucial point from the lesson.
                            </p>
                          </div>
                        </div>
                      </section>
                        ...
                        <Accordion type="single" collapsible className="w-full">
                          <AccordionItem value="exercise1">
                            <AccordionTrigger className="text-left">
                              Exercise 1: Identifying Different Perspectives
                            </AccordionTrigger>
                            <AccordionContent>
                              <div className="prose max-w-none">
                                <p>
                                  This would contain an interactive exercise for users to practice 
                          ...
                          <AccordionItem value="exercise2">
                            ...
                            <AccordionContent>
                              <div className="prose max-w-none">
                                <p>
                                  Reflection questions would go here to help users internalize the lesson material.
                                </p>
