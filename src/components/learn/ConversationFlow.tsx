...
const PhaseTimeline: React.FC<PhaseTimelineProps> = ({ number, title }) => (
  <div className="flex items-start gap-6 mb-1">
    <div className="flex flex-col items-center flex-shrink-0">
      <div className="w-8 h-8 rounded-full bg-dialogue-darkblue text-white flex items-center justify-center text-sm font-semibold">
        {number}
      </div>
    ...
    phases: [
      {
        ...
        messages: [
          ...
          { speaker: "voter", message: "Look I work hard, I'm not married or anything, other people's kids are just other people's problems." }
        ]
      },
      {
        number: 2,
        ...
        messages: [
          ...
          { speaker: "voter", message: "Not really. Most parents I know struggle with childcare costs. My sister has to work two jobs just to afford daycare for her daughter." }
        ]
      },
      {
        number: 3,
        ...
        messages: [
          ...
          { speaker: "voter", message: "She's always stressed about money and finding reliable care. She really wants her daughter to be ready for kindergarten, but quality preschool is just too expensive." }
        ]
      },
      {
        number: 4,
        ...
        messages: [
          ...
          { speaker: "voter", message: "It would be life-changing, honestly. She could focus on one job instead of two, and her daughter would get the early education she deserves." }
        ]
      },
      {
        number: 5,
        ...
        messages: [
          ...
          { speaker: "voter", message: "Definitely a 9 now. I hadn't really thought about how much it would help families like my sister's." }
        ]
      }
    ]
  },
    ...
    phases: [
      {
        ...
        messages: [
          ...
          { speaker: "voter", message: "I'd say around a 4. Healthcare is expensive, but I have insurance through work." },
          { speaker: "canvasser", message: "That makes sense. What makes 4 the right number for you?" },
          { speaker: "voter", message: "Well, I'm covered, so it's not really my problem. People should just get jobs with benefits." }
        ]
      },
      {
        number: 2,
      ...
      },
      {
        ...
        messages: [
          ...
          { speaker: "canvasser", message: "That must be scary for him and the people who care about him. How does that affect your neighborhood?" },
          { speaker: "voter", message: "It's awful. We've had to call an ambulance twice when his blood sugar got dangerous. His wife is always worried sick." }
        ]
      },
      {
        number: 4,
        ...
        messages: [
          ...
          { speaker: "voter", message: "He wouldn't have to choose between rent and medicine. And his wife could stop worrying about losing him." }
        ]
      },
      {
        number: 5,
    ...
    phases: [
      {
        ...
        messages: [
          ...
          { speaker: "voter", message: "Honestly, probably a 2. I don't have anything against them, but I think they already have enough rights." },
          { speaker: "canvasser", message: "Thanks for being honest. What makes 2 feel right to you?" },
          { speaker: "voter", message: "I just think we should focus on other issues. This seems like a distraction from more important things." }
        ]
      },
      {
        number: 2,
    ...
    phases: [
      {
        ...
        messages: [
          ...
          { speaker: "voter", message: "I don't really notice air quality day to day. Seems like an expensive solution to a problem I don't see." }
        ]
      },
      {
        number: 2,
      ...
      },
      {
        ...
        messages: [
          ...
          { speaker: "canvasser", message: "That must be disappointing for him. How does your family feel about those cancelled practices?" },
          { speaker: "voter", message: "He's always so bummed out. And my daughter worries about him running around when the air is bad. She checks the air quality app now before letting him play outside." }
        ]
      },
      {
        number: 4,
        ...
        messages: [
          ...
          { speaker: "voter", message: "He could play soccer year-round without my daughter worrying. Kids could just be kids without checking an app first." }
        ]
      },
      {
        number: 5,
    ...
    phases: [
      {
        ...
        messages: [
          ...
          { speaker: "voter", message: "Probably a 3. I vote in presidential elections, but local stuff doesn't seem to matter much." },
          { speaker: "canvasser", message: "I hear that a lot. What makes local elections feel less important to you?" },
          { speaker: "voter", message: "It's just school board and city council. How much can they really affect my life?" }
        ]
      },
      {
        number: 2,
      ...
      },
      {
        ...
        messages: [
          ...
          { speaker: "canvasser", message: "That's a real daily impact. How has that change affected your routine?" },
          { speaker: "voter", message: "It's annoying, especially in winter. I have to leave earlier, and sometimes I'm late if the bus is delayed. I never even knew they were considering changing it." }
        ]
      },
      {
        number: 4,
        ...
        messages: [
          ...
          { speaker: "voter", message: "Maybe they'd actually consider how it affects working people like me. Maybe they'd hold public meetings that people actually know about." }
        ]
      },
      {
        number: 5,
        ...
        messages: [
          ...
          { speaker: "voter", message: "Probably a 7. I guess these decisions do matter more than I thought." }
        ]
      }
    ]
  },
    ...
    phases: [
      {
        ...
        messages: [
          ...
          { speaker: "canvasser", message: "That's wonderful! What makes you feel so strongly about school funding?" },
          { speaker: "voter", message: "I'm a retired teacher, and I've seen firsthand how underfunded schools hurt kids. Every child deserves proper resources, small class sizes, and updated materials. Education is the foundation of everything." }
        ]
      },
      {
        number: 2,
        ...
        messages: [
          ...
          { speaker: "voter", message: "Absolutely. I'll be first in line to vote, and I'll encourage my neighbors too." },
          { speaker: "canvasser", message: "Perfect! Thank you so much for your support and for all you've done for education. Have a great day!" }
        ]
      }
    ]
  }
