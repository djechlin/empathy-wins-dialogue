            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-center">
              <div className="lg:col-span-3">
                ...
                <p className="text-lg opacity-90 mb-6 max-w-lg">
                  Join type2dialogue today and be part of a movement creating meaningful political dialogue that bridges divides and builds
                  electoral success.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button size="lg" className="bg-white text-dialogue-darkblue hover:bg-dialogue-blue transition-colors">
                    Start a Dialogue
                  </Button>
                  <Button
                    size="lg"
              ...
              <div className="lg:col-span-2">
                <div className="bg-white p-6 rounded-lg shadow-inner">
                  <h3 className="font-heading font-semibold text-dialogue-darkblue mb-4 text-xl">Join Our Newsletter</h3>
                  ...
                  <div className="space-y-4">
                    ...
                    />
                    <Button className="w-full bg-dialogue-purple hover:bg-dialogue-darkblue">Subscribe</Button>
                  </div>
                </div>
              </div>
            </div>
