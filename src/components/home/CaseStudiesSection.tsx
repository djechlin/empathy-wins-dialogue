  ...
  const caseStudies = [
    {
      ...
      description: "Canvassers trained with type2dialogue moved 12% more voters from oppose to support compared to traditional training methods.",
      icon: TrendingUp
    },
    {
    ...
    },
    {
      ...
      description: "Volunteers reported having deeper, more productive conversations with voters after practicing vulnerability techniques.",
      icon: MessageSquare
    },
    {
    ...
    },
    {
      ...
      description: "Districts using type2dialogue training showed 4-point improvement in candidate favorability compared to control groups.",
      icon: Users
    },
    {
      ...
      <div className="container-custom">
        <div className="text-center mb-12">
          <h2 className="font-serif text-4xl md:text-5xl text-dialogue-darkblue mb-6">
            Proven Results Across Campaigns
          </h2>
          <p className="text-xl text-foreground max-w-3xl mx-auto leading-relaxed">
            Campaign managers across the country are seeing measurable improvements in voter persuasion 
            and volunteer performance with type2dialogue training.
          </p>
        </div>
