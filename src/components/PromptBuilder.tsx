...
interface PromptBuilderProps {
  ...
  onDataChange?: (data: { fullPrompt: string; firstMessage: string; variables: Record<string, string>; displayName: string }) => void;
}
...
const PromptBuilder = forwardRef<PromptBuilderRef, PromptBuilderProps>(
  ({ name, color, initialPrompt = '', initialVariables = {}, showFirstMessage = false, onPromptChange, onDataChange }, ref) => {
    ...
    useEffect(() => {
      ...
      onDataChange?.({ fullPrompt, firstMessage, variables, displayName });
    }, [fullPrompt, firstMessage, variables, displayName, onPromptChange, onDataChange]);
