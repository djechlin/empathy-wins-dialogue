...
import { getDeepgramAccessToken } from '@/lib/getDeepgramAccessToken';

interface DeepgramVoiceProviderProps {
    configId?: string;
    children: ReactNode;
...
export function DeepgramVoiceProvider({
    children,
    configId,
    onMessage,
    className,
